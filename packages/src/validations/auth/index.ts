import z from "zod";
import { zodValidationEmail, zodValidationOTPCode, zodValidationPassword, zodValidationPhoneNumber, zodValidationOTPCodeSignIn, zodValidationFirstName, zodValidationLastName, zodValidationGender, zodValidationConfirmPassword, zodValidationBirthday, zodValidationFullName } from "../variables";
