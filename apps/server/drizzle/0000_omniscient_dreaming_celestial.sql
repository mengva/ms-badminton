...
ALTER TABLE "images" ADD CONSTRAINT "images_court_id_courts_id_fk" FOREIGN KEY ("court_id") REFERENCES "public"."courts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "court_owners_company_idx" ON "court_owners" USING btree ("company_name");--> statement-breakpoint
...
CREATE INDEX "check_outs_customer_id_idx" ON "check_outs" USING btree ("customer_id");