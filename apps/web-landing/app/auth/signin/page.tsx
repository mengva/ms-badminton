...
import { zodValidationSignIn, ZodValidationSignIn } from "@/landing/packages/validations";
...
export default function SignInPage() {
    ...
    const signInMutation = trpc.app.user.auth.login.useMutation({
                    ...
                    <CardContent>
                        ...
                        <div className="mt-4 flex items-center justify-between text-sm">
                            ...
                            <Link
                                href="/auth/signup"
                            >
                                <Badge variant="secondary">ລົງທະບຽນ</Badge>
                            </Link>
                        </div>
                    </CardContent>
                </Card>
